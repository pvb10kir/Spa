...
send_api_msg(msg, get_receiver_api(msg), text, true, 'md')
      ...
      local sambutan = "*Hi* [ "..msg.from.print_name.." ](https://telegram.me/"..msg.from.username..") *WelCome to:* '_"..string.gsub(msg.to.print_name, "_", " ").."_'\n_Send Me_ /start _For Help you_\n\n"
