...
local function run(msg, matches)
  ...
  local url = "http://assets.imgix.net/examples/vista.png?w=1000&w=1000&h=1000&fit=crop&txt="..lionteam.."&txtsize="..size.."&txtclr="..f.."&txtalign=middle,center&txtfont=Futura%20Condensed%20Medium&mono=ff6598cc=?markscale=60&markalign"
  local ext = ".webp"
